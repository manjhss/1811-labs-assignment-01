...
function Revolutionalize() {
	return (
		<section className="w-[1150px] m-auto">
			...
			<div className="grid gap-24 grid-cols-2 mt-20 place-items-end">
				<div className="relative -top-24 flex justify-center items-stretch">
					<div className="w-[88%]">
						<img src="/user-acc-card.png" alt="" />
					</div>
				...
				<div className="space-y-[32px] px-[39px] py-[48px] border-2 border-gray-600 rounded-2xl">
