...
function Unleash() {
	return (
		<section className="xl:w-[1150px] m-auto space-y-[80px] flex flex-col items-center">
			<div className="space-y-[24px] flex flex-col justify-center">
				<h2 className="text-[56px] font-bold text-center bg-gradient-to-br from-white via-gray-300 to-gray-600 text-transparent bg-clip-text inline-block">
					Unleash the <br className="hidden xl:block" /> power of AI
				</h2>

				<p className="text-[24px] text-center">
					Automatically generate high-quality sequences uniquely
					crafted <br className="hidden xl:block" /> for your value
					proposition and your target prospects.
				</p>
			</div>

			<div className="lg:w-[926px] w-full p-6 lg:p-[50px] pb-[64px] border-2 border-slate-400/40 rounded-xl space-y-[50px]">
				...
				<div className="space-y-[20px]">
					<div className="text-[32px] font-semibold flex flex-wrap items-center gap-[30px]">
